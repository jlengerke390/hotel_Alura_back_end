...
import co.jelc.project.persistence.JDBCUserDAO;
...
public class Login extends JFrame {
	 ...
	 */
	public Login() {
		this.jDBCUserDAO = new JDBCUserDAO(new ConnectionFactory().recoverConnection());
		setResizable(false);
		setUndecorated(true);
	...
	private void Login() {
		...
		if(jDBCUserDAO.validateByCredentials(txtUsuario.getText(), password)) {
